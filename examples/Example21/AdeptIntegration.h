...
private:
  ...
  std::unordered_map<int, int> *fvecgeom_to_g4_map; ///< Maps Vecgeom placement IDs to geant4 ones
  std::unordered_map<int, int> *fvolume_to_hit_map; ///< Maps Vecgeom placement IDs to Hits
