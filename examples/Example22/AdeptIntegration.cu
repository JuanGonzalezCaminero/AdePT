...
#include "electrons_newscoring.cuh"
// #include "gammas.cuh"
#include "gammas_newscoring.cuh"
...
/// TEMP
__global__ void PrintBufferStateGPU(HostScoring *aScoring_device)
{
  printf("DEBUG: Buffer Start: %u\n", aScoring_device->fBufferStart);
  printf("DEBUG: Buffer Usage: %u\n", aScoring_device->fUsedSlots_d->load());
  printf("DEBUG: Next Free Hit: %u\n", aScoring_device->fNextFreeHit_d->load());
